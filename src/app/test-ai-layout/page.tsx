...
The AI should be able to answer based on this article's content without covering the text you're reading.`,
  ...
  tags: JSON.stringify(['testing', 'ai-assistant', 'layout', 'user-experience']),
  status: 'PUBLISHED' as const,
  publishedAt: new Date(),
  readTime: 5,
  seoTitle: 'Testing AI Assistant Layout',
  seoDescription: 'Test page for the new AI assistant layout design',
  seoKeywords: JSON.stringify(['ai assistant', 'layout', 'testing']),
  createdAt: new Date(),
  updatedAt: new Date(),
  ...
  division: {
    ...
    sdgAlignment: JSON.stringify(['SDG 9: Industry, Innovation and Infrastructure']),
    color: '#FFD700',
    icon: 'lightbulb',
    createdAt: new Date(),
    updatedAt: new Date()
