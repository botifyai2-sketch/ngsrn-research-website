...
> "The future of African agriculture lies in sustainable practices that work with nature, not against it." - Dr. Amina Hassan, Agricultural Sustainability Expert`,
  ...
  seoKeywords: JSON.stringify(['sustainable agriculture', 'Sub-Saharan Africa', 'climate change', 'food security']),
  ...
  division: {
    ...
    sdgAlignment: JSON.stringify(['SDG 13: Climate Action', 'SDG 15: Life on Land', 'SDG 14: Life Below Water']),
    color: '#228B22',
    icon: 'leaf',
    createdAt: new Date(),
    updatedAt: new Date()
